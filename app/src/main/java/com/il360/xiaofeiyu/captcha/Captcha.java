package com.il360.xiaofeiyu.captcha;
...
public class Captcha extends LinearLayout {
    ...
    public Captcha(@NonNull final Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        ...
        drawableId = typedArray.getResourceId(R.styleable.Captcha_src, R.drawable.dog_ori);
        ...
        mMode = typedArray.getInteger(R.styleable.Captcha_mode_self, MODE_BAR);
...
//                accessSuccess.setVisibility(VISIBLE);
    ...
    public void setBitmap(Bitmap bitmap, Bitmap blockImage, int top) {
        vertifyView.setBitmap(bitmap, blockImage, top);
        vertifyView.setImageBitmap(bitmap);
        reset(false);
    }
