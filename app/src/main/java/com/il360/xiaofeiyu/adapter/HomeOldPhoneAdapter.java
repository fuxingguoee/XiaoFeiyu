...
public class HomeOldPhoneAdapter extends BaseAdapter {
	private Context context;
	private LayoutInflater mInflater;
	private List<Goods> list;
	DecimalFormat df = new DecimalFormat("0.00");

	public HomeOldPhoneAdapter(List<Goods> list, Context context) {
...
//			convertView = mInflater.inflate(R.layout.listitem_home_old_phone, null);
